                ...
                <>
                    <div className='mt-4'>
                        ...
                        <div className='d-flex flex-column align-items-center' >
                            <h3 className='mb-0 fs-2'> {data.hasOwnProperty('name') ? data.name : "Loading..."}</h3>
                            <p className='mb-0' style={{ fontSize: "4rem" }}>{parseInt(data.main.temp - 273.15) + "°"}</p>
                            <p className='fw-bold mb-0'>{capitalizeEveryWord(data.weather[0].description)}</p>
                            <div>
                                <span className='fw-bold fs-4 me-2'>MAX: {parseInt(data.main.temp_max - 273.15) + "°"}</span><span> </span> <span className='fw-bold fs-4'>MIN: {parseInt(data.main.temp_min - 273.15) + "°"}</span>
                            </div>
                            ...
                            <div className='d-flex justify-content-between mt-5 container px-0 '>
                                ...
                                <div>
                                    <div className='sunrise p-3 bordo carousel-slide2 me-3'>
                                        ...
                                        <div className='d-flex  align-items-center' style={{ height: "20px" }}>
                                            <img src="https://icons.iconarchive.com/icons/iconsmind/outline/256/Sunrise-icon.png" alt="" style={{ width: "20px" }} />
                                            <p className='my-0 ms-2'>LEVATA DEL SOLE</p>
                                        </div>
                                        <p className='secondo'>{convertTimestampToTime(data.sys.sunrise)} </p>
